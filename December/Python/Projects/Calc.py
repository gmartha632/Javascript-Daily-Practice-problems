...
class Calculator:
    def __init__(self, master):
        ...
        self.entry = Entry(master, width=17, bg="#fff", font=("Arial Bold", 28), textvariable=self.equation)
        ...
        Button(width = 11 , height = 4 , text = 'X' ,relief = 'flat' , bg = 'white' ,command = lambda : self.show('X')).place(x = 270, y = 350)
